...
class WWWTree {
 ...
 protected: 
  ...
  int      nLbnt3lElec_;
  TBranch *nLbnt3lElec_branch;
  bool     nLbnt3lElec_isLoaded;
  vector<int> *Lbnt3lElec_;
  TBranch *Lbnt3lElec_branch;
  bool     Lbnt3lElec_isLoaded;
  int      nLbnt3lLepton_;
  TBranch *nLbnt3lLepton_branch;
  bool     nLbnt3lLepton_isLoaded;
  vector<int> *Lbnt3lLepton_;
  TBranch *Lbnt3lLepton_branch;
  bool     Lbnt3lLepton_isLoaded;
  int      nLbnt3lMuon_;
  TBranch *nLbnt3lMuon_branch;
  bool     nLbnt3lMuon_isLoaded;
  vector<int> *Lbnt3lMuon_;
  TBranch *Lbnt3lMuon_branch;
  bool     Lbnt3lMuon_isLoaded;
  int      nLbntElec_;
  TBranch *nLbntElec_branch;
  bool     nLbntElec_isLoaded;
  vector<int> *LbntElec_;
  TBranch *LbntElec_branch;
  bool     LbntElec_isLoaded;
  int      nLbntLepton_;
  TBranch *nLbntLepton_branch;
  bool     nLbntLepton_isLoaded;
  vector<int> *LbntLepton_;
  TBranch *LbntLepton_branch;
  bool     LbntLepton_isLoaded;
  int      nLbntMuon_;
  TBranch *nLbntMuon_branch;
  bool     nLbntMuon_isLoaded;
  vector<int> *LbntMuon_;
  TBranch *LbntMuon_branch;
  bool     LbntMuon_isLoaded;
  int      nLooseElec_;
  TBranch *nLooseElec_branch;
  bool     nLooseElec_isLoaded;
  vector<int> *LooseElec_;
  TBranch *LooseElec_branch;
  bool     LooseElec_isLoaded;
  int      nLooseLepton_;
  TBranch *nLooseLepton_branch;
  bool     nLooseLepton_isLoaded;
  vector<int> *LooseLepton_;
  TBranch *LooseLepton_branch;
  bool     LooseLepton_isLoaded;
  int      nLooseMuon_;
  TBranch *nLooseMuon_branch;
  bool     nLooseMuon_isLoaded;
  vector<int> *LooseMuon_;
  TBranch *LooseMuon_branch;
  bool     LooseMuon_isLoaded;
  int      nSignalElec_;
  TBranch *nSignalElec_branch;
  bool     nSignalElec_isLoaded;
  vector<int> *SignalElec_;
  TBranch *SignalElec_branch;
  bool     SignalElec_isLoaded;
  int      nSignalLepton_;
  TBranch *nSignalLepton_branch;
  bool     nSignalLepton_isLoaded;
  vector<int> *SignalLepton_;
  TBranch *SignalLepton_branch;
  bool     SignalLepton_isLoaded;
  int      nSignalMuon_;
  TBranch *nSignalMuon_branch;
  bool     nSignalMuon_isLoaded;
  vector<int> *SignalMuon_;
  TBranch *SignalMuon_branch;
  bool     SignalMuon_isLoaded;
  int      nTight3lElec_;
  TBranch *nTight3lElec_branch;
  bool     nTight3lElec_isLoaded;
  vector<int> *Tight3lElec_;
  TBranch *Tight3lElec_branch;
  bool     Tight3lElec_isLoaded;
  int      nTight3lLepton_;
  TBranch *nTight3lLepton_branch;
  bool     nTight3lLepton_isLoaded;
  vector<int> *Tight3lLepton_;
  TBranch *Tight3lLepton_branch;
  bool     Tight3lLepton_isLoaded;
  int      nTightElec_;
  TBranch *nTightElec_branch;
  bool     nTightElec_isLoaded;
  vector<int> *TightElec_;
  TBranch *TightElec_branch;
  bool     TightElec_isLoaded;
  int      nTightLepton_;
  TBranch *nTightLepton_branch;
  bool     nTightLepton_isLoaded;
  vector<int> *TightLepton_;
  TBranch *TightLepton_branch;
  bool     TightLepton_isLoaded;
  int      nTightMuon_;
  TBranch *nTightMuon_branch;
  bool     nTightMuon_isLoaded;
  vector<int> *TightMuon_;
  TBranch *TightMuon_branch;
  bool     TightMuon_isLoaded;
  int      nVetoElec_;
  TBranch *nVetoElec_branch;
  bool     nVetoElec_isLoaded;
  vector<int> *VetoElec_;
  TBranch *VetoElec_branch;
  bool     VetoElec_isLoaded;
  int      nVetoLepton_;
  TBranch *nVetoLepton_branch;
  bool     nVetoLepton_isLoaded;
  vector<int> *VetoLepton_;
  TBranch *VetoLepton_branch;
  bool     VetoLepton_isLoaded;
  int      nVetoMuon_;
  TBranch *nVetoMuon_branch;
  bool     nVetoMuon_isLoaded;
  vector<int> *VetoMuon_;
  TBranch *VetoMuon_branch;
  bool     VetoMuon_isLoaded;
  int      nGood3LJet_;
  TBranch *nGood3LJet_branch;
  bool     nGood3LJet_isLoaded;
  vector<int> *Good3LJet_;
  TBranch *Good3LJet_branch;
  bool     Good3LJet_isLoaded;
  int      nGoodSSJet_;
  TBranch *nGoodSSJet_branch;
  bool     nGoodSSJet_isLoaded;
  vector<int> *GoodSSJet_;
  TBranch *GoodSSJet_branch;
  bool     GoodSSJet_isLoaded;
  int      nGoodSSWJet_;
  TBranch *nGoodSSWJet_branch;
  bool     nGoodSSWJet_isLoaded;
  vector<int> *GoodSSWJet_;
  TBranch *GoodSSWJet_branch;
  bool     GoodSSWJet_isLoaded;
  int      nLooseBJet_;
  TBranch *nLooseBJet_branch;
  bool     nLooseBJet_isLoaded;
...
void LoadAllBranches(); 
  ...
  const int &nLbnt3lElec();
  const vector<int> &Lbnt3lElec();
  const int &nLbnt3lLepton();
  const vector<int> &Lbnt3lLepton();
  const int &nLbnt3lMuon();
  const vector<int> &Lbnt3lMuon();
  const int &nLbntElec();
  const vector<int> &LbntElec();
  const int &nLbntLepton();
  const vector<int> &LbntLepton();
  const int &nLbntMuon();
  const vector<int> &LbntMuon();
  const int &nLooseElec();
  const vector<int> &LooseElec();
  const int &nLooseLepton();
  const vector<int> &LooseLepton();
  const int &nLooseMuon();
  const vector<int> &LooseMuon();
  const int &nSignalElec();
  const vector<int> &SignalElec();
  const int &nSignalLepton();
  const vector<int> &SignalLepton();
  const int &nSignalMuon();
  const vector<int> &SignalMuon();
  const int &nTight3lElec();
  const vector<int> &Tight3lElec();
  const int &nTight3lLepton();
  const vector<int> &Tight3lLepton();
  const int &nTightElec();
  const vector<int> &TightElec();
  const int &nTightLepton();
  const vector<int> &TightLepton();
  const int &nTightMuon();
  const vector<int> &TightMuon();
  const int &nVetoElec();
  const vector<int> &VetoElec();
  const int &nVetoLepton();
  const vector<int> &VetoLepton();
  const int &nVetoMuon();
  const vector<int> &VetoMuon();
  const int &nGood3LJet();
  const vector<int> &Good3LJet();
  const int &nGoodSSJet();
  const vector<int> &GoodSSJet();
  const int &nGoodSSWJet();
  const vector<int> &GoodSSWJet();
  const int &nLooseBJet();
